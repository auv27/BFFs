...
source("C:/Users/Alicia/OneDrive - The Pennsylvania State University/Research Projects/Standard Codes/alicia_theme.R")
...
read.csv("C:/Users/Alicia/OneDrive - The Pennsylvania State University/Research Projects/F31/BFFs/data_processing/stimuli_creation/tpv_04/coding/dyad_04_behavior.csv", stringsAsFactors = FALSE) %>%
  ...
  mutate(id1 = "2337_04_07", id2 = "2337_04_08") %>%
...
Reduce(function(...) {full_join(...)}, list(neg, pos, neu)) %>%
  arrange(onset) %>%
  mutate(fileType = ".mp4",
         filePath = "clips/") -> all_clips
write.csv(all_clips, "C:/Users/Alicia/OneDrive - The Pennsylvania State University/Research Projects/F31/BFFs/data_processing/stimuli_creation/tpv_04/coding/dyad_04_selectedAffect.csv", row.names = FALSE)
```
...
write.csv(epochs, "C:/Users/Alicia/OneDrive - The Pennsylvania State University/Research Projects/F31/BFFs/data_processing/stimuli_creation/tpv_04/coding/dyad_04_epochs.csv", row.names = FALSE)
...
write.csv(id1_random, "C:/Users/Alicia/OneDrive - The Pennsylvania State University/Research Projects/F31/BFFs/data_processing/stimuli_creation/tpv_04/2337_04_07_epochs.csv", row.names = FALSE)
...
write.csv(id2_random, "C:/Users/Alicia/OneDrive - The Pennsylvania State University/Research Projects/F31/BFFs/data_processing/stimuli_creation/tpv_04/2337_04_08_epochs.csv", row.names = FALSE)
```
