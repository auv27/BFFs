...
read.csv("C:/Users/Alicia/OneDrive - The Pennsylvania State University/Research Projects/F31/BFFs/data_processing/stimuli_creation/tpv_02/coding/dyad_02_behavior.csv", stringsAsFactors = FALSE) %>%
  ...
  mutate(id1 = "2337_02_03", id2 = "2337_02_04") %>%
...
Reduce(function(...) {full_join(...)}, list(neg, pos, neu)) %>%
  arrange(onset) %>%
  mutate(fileType = ".mp4",
         filePath = "subject_files/dyad_02/clips/") -> all_clips

write.csv(all_clips, "C:/Users/Alicia/OneDrive - The Pennsylvania State University/Research Projects/F31/BFFs/data_processing/stimuli_creation/tpv_02/coding/dyad_02_selectedAffect.csv")
```
...
write.csv(epochs, "C:/Users/Alicia/OneDrive - The Pennsylvania State University/Research Projects/F31/BFFs/data_processing/stimuli_creation/tpv_02/coding/dyad_02_epochs.csv")
...
write.csv(id1_random, "C:/Users/Alicia/OneDrive - The Pennsylvania State University/Research Projects/F31/BFFs/data_processing/stimuli_creation/tpv_02/03_epochs.csv", row.names = FALSE)
...
write.csv(id2_random, "C:/Users/Alicia/OneDrive - The Pennsylvania State University/Research Projects/F31/BFFs/data_processing/stimuli_creation/tpv_02/04_epochs.csv", row.names = FALSE)
```
