...
read.csv("C:/Users/Alicia/OneDrive - The Pennsylvania State University/Research Projects/F31/BFFs/data_processing/stimuli_creation/tpv_03/coding/dyad_03_behavior.csv", stringsAsFactors = FALSE) %>%
  ...
  mutate(id1 = "2337_03_05", id2 = "2337_03_06") %>%
...
write.csv(all_clips, "C:/Users/Alicia/OneDrive - The Pennsylvania State University/Research Projects/F31/BFFs/data_processing/stimuli_creation/tpv_03/coding/dyad_03_selectedAffect.csv")
```
...
write.csv(epochs, "C:/Users/Alicia/OneDrive - The Pennsylvania State University/Research Projects/F31/BFFs/data_processing/stimuli_creation/tpv_03/coding/dyad_03_epochs.csv")
...
random.sample(id1) %>%
  ungroup() %>%
  select(clips, emotion) %>%
  mutate(path = "subject_files/dyad_03/") %>%
  unite(clips, path, clips, sep = "") -> id1_random
write.csv(id1_random, "C:/Users/Alicia/OneDrive - The Pennsylvania State University/Research Projects/F31/BFFs/data_processing/stimuli_creation/tpv_03/2337_03_05_epochs.csv", row.names = FALSE)
...
random.sample(id2) %>%
  ...
  select(clips, emotion) %>%
  mutate(path = "subject_files/dyad_03/") %>%
  unite(clips, path, clips, sep = "")-> id2_random
write.csv(id2_random, "C:/Users/Alicia/OneDrive - The Pennsylvania State University/Research Projects/F31/BFFs/data_processing/stimuli_creation/tpv_03/2337_03_06_epochs.csv", row.names = FALSE)
```
