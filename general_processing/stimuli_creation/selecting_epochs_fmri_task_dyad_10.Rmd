...
read.csv("C:/Users/Alicia/OneDrive - The Pennsylvania State University/Research Projects/F31/BFFs/data_processing/stimuli_creation/tpv_10/coding/dyad_10_behavior.csv", stringsAsFactors = FALSE) %>%
  ...
  mutate(id1 = "2337_10_19", id2 = "2337_10_20") %>%
  ...
  mutate(meanNeg = mean(c(neg1, neg2)),
         ...
         ## For this dyad need to keep epoch 42 & 43 for enough neg
         selectedAffect = ifelse(epoch == 42 | epoch == 43, -1, selectedAffect)) %>%
  as.data.frame() %>%
  na.omit() -> df
```
...
## For this dyad need to keep epoch 42 for enough neg
df %>%
  ...
  mutate(selectedSegments = ifelse(selectedAffect == relativeAffect, 1,
         ...
         ## For this dyad need to keep epoch 42 for enough neg
         selectedSegments = ifelse(onset == 840000 | onset == 860000, 1, selectedSegments)) %>%
  na.omit() -> neg_pos_neu
...
Reduce(function(...) {full_join(...)}, list(neg, pos, neu)) %>%
  arrange(onset) %>%
  mutate(fileType = ".mp4",
         filePath = "subject_files/dyad_10/clips/") -> all_clips

write.csv(all_clips, "C:/Users/Alicia/OneDrive - The Pennsylvania State University/Research Projects/F31/BFFs/data_processing/stimuli_creation/tpv_10/coding/dyad_10_selectedAffect.csv")
```
...
write.csv(epochs, "C:/Users/Alicia/OneDrive - The Pennsylvania State University/Research Projects/F31/BFFs/data_processing/stimuli_creation/tpv_10/coding/dyad_10_epochs.csv")
...
write.csv(id1_random, "C:/Users/Alicia/OneDrive - The Pennsylvania State University/Research Projects/F31/BFFs/data_processing/stimuli_creation/tpv_10/19_epochs.csv", row.names = FALSE)
...
write.csv(id2_random, "C:/Users/Alicia/OneDrive - The Pennsylvania State University/Research Projects/F31/BFFs/data_processing/stimuli_creation/tpv_10/20_epochs.csv", row.names = FALSE)
```
