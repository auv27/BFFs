...
read.csv("~/Library/CloudStorage/OneDrive-ThePennsylvaniaStateUniversity/Research Projects/F31/BFFs/data_processing/stimuli_creation/tpv_14/coding/dyad_14_behavior.csv", stringsAsFactors = FALSE) %>%
  ...
  mutate(id1 = "2337_14_27", id2 = "2337_14_28") %>%
...
Reduce(function(...) {full_join(...)}, list(neg, pos, neu)) %>%
  arrange(onset) %>%
  mutate(fileType = ".mp4",
         filePath = "subject_files/dyad_14/clips/") -> all_clips

write.csv(all_clips, "~/Library/CloudStorage/OneDrive-ThePennsylvaniaStateUniversity/Research Projects/F31/BFFs/data_processing/stimuli_creation/tpv_14/coding/dyad_14_selectedAffect.csv")
```
...
write.csv(epochs, "~/Library/CloudStorage/OneDrive-ThePennsylvaniaStateUniversity/Research Projects/F31/BFFs/data_processing/stimuli_creation/tpv_14/coding/dyad_14_epochs.csv")
...
write.csv(id1_random, "~/Library/CloudStorage/OneDrive-ThePennsylvaniaStateUniversity/Research Projects/F31/BFFs/data_processing/stimuli_creation/tpv_14/27_epochs.csv", row.names = FALSE)
...
write.csv(id2_random, "~/Library/CloudStorage/OneDrive-ThePennsylvaniaStateUniversity/Research Projects/F31/BFFs/data_processing/stimuli_creation/tpv_14/28_epochs.csv", row.names = FALSE)
```
